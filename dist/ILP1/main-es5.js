(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddEmployeeComponent = /** @class */ (function () {
                ...
                AddEmployeeComponent.prototype.onSubmit = function (emp) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditEmployeeComponent = /** @class */ (function () {
                function EditEmployeeComponent(_employeeService, router, route) {
                    this._employeeService = _employeeService;
                    this.router = router;
                    this.route = route;
                    this.countries = ['Bangalore', 'Chennai', 'Pune', 'Hyderabad'];
                ...
                EditEmployeeComponent.prototype.ngOnInit = function () {
                    ...
                    this._employeeService.ListEmployeeByID(this.id).subscribe(function (res) {
                        _this.employee = res[0];
                    }, function (error) {
                        console.log(error);
                    });
                };
                EditEmployeeComponent.prototype.onSubmit = function (id, emp) {
                    var _this = this;
                    console.log(id, emp);
                    emp.id = id;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeeComponent = /** @class */ (function () {
                function EmployeeComponent(_employeeService, route) {
                    this._employeeService = _employeeService;
                    this.route = route;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListEmployeeComponent = /** @class */ (function () {
                ...
                ListEmployeeComponent.prototype.onLoad = function () {
                    var _this = this;
                    this._employeeService.ListEmployee()
                        .subscribe(function (res) {
                        _this.employees = res;
                        _this.employeesLocal = res;
                        _this.onFilter(_this.filter);
                    }, function (error) {
                        console.log(error);
                    });
                };
                ListEmployeeComponent.prototype.onSort = function () {
                    // tslint:disable-next-line: variable-name
                    this.employees = Object.assign([], this.employees).sort(function (_a, _b) { return _a.id - _b.id; });
                };
                ListEmployeeComponent.prototype.onFilter = function (res) {
                    var _this = this;
                    this.employees = this.employeesLocal;
                    this.filter = res;
                    if (this.filter) {
                        this.employees = this.employees.filter(function (emp) {
                            return emp.id.toLocaleLowerCase().includes(_this.filter.toLocaleLowerCase()) ||
                                emp.name.toLocaleLowerCase().includes(_this.filter.toLocaleLowerCase()) ||
                                emp.location.toLocaleLowerCase().includes(_this.filter.toLocaleLowerCase()) ||
                                emp.email.toLocaleLowerCase().includes(_this.filter.toLocaleLowerCase()) ||
                                emp.mobile.toLocaleLowerCase().includes(_this.filter.toLocaleLowerCase());
                        });
                    }
                    this.onSort();
                };
                ListEmployeeComponent.prototype.onDelete = function (id) {
                    var _this = this;
                    this._employeeService.DeleteEmployee(id).subscribe(function (res) {
                        _this.onLoad();
                    }, function (error) {
                        console.log(error);
                    });
            ...
            ListEmployeeComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DbService = /** @class */ (function () {
                ...
                DbService.prototype.createDb = function () {
                    var emp = _data_employees__WEBPACK_IMPORTED_MODULE_2__["employees"];
                    return { emp: emp };
                };
                return DbService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeeService = /** @class */ (function () {
                ...
                EmployeeService.prototype.ListEmployee = function () {
                ...
                EmployeeService.prototype.ListEmployeeByID = function (id) {
                    // tslint:disable-next-line: no-shadowed-variable
                    // const employees = JSON.parse(localStorage.getItem('employees'));
                    // return employees.filter(emp => emp.id === id);
                    return this._httpClient.get(this.SERVER_URL).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) {
                        return data.filter(function (emp) { return emp.id === id; });
